...
//	2.2 shingle to integers
	string doc;
//	read doc from doc_read stream
...
//	save integer matrix to local file
	string sgMat_path = "shingleMat";
	FILE* mfp = fopen(sgMat_path.c_str(), "wb");
	fwrite(shingleMat, sizeof(shingleMat), 1, mfp);
	fclose(mfp);
